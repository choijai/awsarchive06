 ...
 * - 2개 어느 정도 가능한 선택지
 */
export const SAA_PROBLEM_PROMPT_MEDIUM = `⚠️ **CRITICAL: 응답은 정확히 2000 토큰 이내여야 합니다. 초과하면 안 됩니다.**
 ...
 * - 실무 수준의 아키텍처 이해 필요
 */
export const SAA_PROBLEM_PROMPT_HARD = `⚠️ **CRITICAL: 응답은 정확히 2000 토큰 이내여야 합니다. 초과하면 안 됩니다.**
 ...
 */
export const SAA_PROBLEM_PROMPT_CHALLENGE = `⚠️ **CRITICAL: 응답은 정확히 2000 토큰 이내여야 합니다. 초과하면 안 됩니다.**
...
export const SAA_PROBLEM_PROMPT_EN = `⚠️ **CRITICAL: Response must be exactly within 2000 tokens. Do not exceed.**
...
export const SAA_PROBLEM_PROMPT_EN_HARD = `⚠️ **CRITICAL: Response must be exactly within 2000 tokens. Do not exceed.**
...
export const SAA_PROBLEM_PROMPT_EN_CHALLENGE = `⚠️ **CRITICAL: Response must be exactly within 2000 tokens. Do not exceed.**
