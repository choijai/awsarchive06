...
JSON 형식으로 응답해주세요 (마크다운 코드 블록 없이 순수 JSON, 모든 문자열 값은 줄바꿈 없이 한 줄):
{
  "question": "시나리오... (2-4문장)",
  ...
  "goal": "이 문제의 핵심 목표를 한 문장으로",
  "easyMode": {
    "explanation": "정답의 초등학교 5학년 수준 설명 (비유법 사용)",
...
⚠️ 중요: 모든 문자열 값은 반드시 한 줄로 작성하고, 큰따옴표나 줄바꿈을 포함하지 마세요.`;
...
JSON 형식으로 응답 (마크다운 없이 순수 JSON, 모든 값은 한 줄):
{
  ...
  "goal": "이 문제의 핵심 목표",
  "easyMode": {
    "explanation": "정답의 초등학교 5학년 수준 설명",
    "A": "선택지 A 설명",
    "B": "선택지 B 설명",
    "C": "선택지 C 설명",
    "D": "선택지 D 설명"
